...
export default function CreateTaskForm(props: {
  ...
  const projectOptions: Option[] = projects?.map((project: { _id: string; emoji: string; name: string }) => {
    return {
      label: (
  ...
  const membersOptions: Option[] = members?.map((member: Member) => {
    ...
    label: (
      <div className="flex items-center space-x-2">
        <Avatar className="h-7 w-7">
          <AvatarImage src={member.userId?.profilePicture ?? undefined} alt={name} />
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        ...
                        <div className="w-full max-h-[200px] overflow-y-auto scrollbar">
                          {projectOptions?.map((option: Option) => (
                            <SelectItem
                              key={option.value}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      <div className="w-full max-h-[200px] overflow-y-auto scrollbar">
                        {membersOptions?.map((option: Option) => (
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      {priorityOptions?.map((priority: Option) => (
